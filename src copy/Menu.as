package
{
    ...
    public class Menu extends Screen
    {
		...
		private var headingText:TextArea;
		private var detailText:TextArea;
		...
		private function createTabBar():void
		{
			...
			var square:Quad = new Quad(Constants.STAGE_WIDTH, Constants.STAGE_HEIGHT/100*10,0x000000 )
				addChild(square);
				square.y=Constants.STAGE_HEIGHT-Constants.STAGE_HEIGHT/100*10;
			var tabs:ButtonGroup = new ButtonGroup();
			...
			tabs.dataProvider = new ListCollection(
				[
					...
					{ label: "Prepare", triggered: onviewExamsButTriggered },
