package 
{
	...
	public class SearchSubjects extends Screen
	{
		...
		private var _editButton:feathers.controls.TabBar;
		...
		private function editButton_changeHandler():void
		{
			...
			filterBoard = myArray[_editButton.selectedIndex];
		...
		private function addSearchInput():void 
		{
			...
			searchTextInput.y=(Constants.STAGE_HEIGHT/100)*8+_editButton.height;
		...
		private function makeList():void
		{
			...
			//list.addEventListener(starling.events.Event.TRIGGERED, listAddedToStage);
			//list.addEventListener(Event.SCROLL, list_scrollHandler);
		
			this._editButton = new feathers.controls.TabBar;
			_editButton.dataProvider=new ListCollection(["AQA","EDEXCEL", "OCR", "WJEC" ])
			//this._editButton. = true;
			//this._editButton.label = "Edit";
			this._editButton.addEventListener(starling.events.Event.CHANGE, editButton_changeHandler);
			
			_editButton.height=(Constants.STAGE_HEIGHT/100)*7;
			_editButton.y = header.height
			_editButton.width = Constants.STAGE_WIDTH;
			/*_editButton.nameList.add(SpurnTheme.ALTERNATE_NAME_MY_TAB_MIDDLE)
			_editButton.customFirstTabName = SpurnTheme.ALTERNATE_NAME_MY_TAB_FIRST;
			_editButton.customLastTabName = SpurnTheme.ALTERNATE_NAME_MY_TAB_LAST;*/
			...
			//_mainTab.nameList.add(SpurnTheme.ALTERNATE_NAME_MY_TAB_MIDDLE)
			/*_mainTab.customFirstTabName = SpurnTheme.ALTERNATE_NAME_MY_TAB_FIRST;
			_mainTab.customLastTabName = SpurnTheme.ALTERNATE_NAME_MY_TAB_LAST;*/
			
			
			
			_mainTab.validate();
			_editButton.validate();
			addChild(_editButton);
			
			list.width = Constants.STAGE_WIDTH;
			list.height =  (Constants.STAGE_HEIGHT/100)*35;
			list.x = 0;
			list.y =  ((Constants.STAGE_HEIGHT/100)*17)+_editButton.height;
