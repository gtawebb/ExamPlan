package themes
{
	...
	public class SpurnTheme extends MetalWorksMobileTheme
	{
		...
		protected function myParaText(textInput:TextInput):void
		{
		...
		protected function myDetailsText(textInput:TextInput):void
		{
			// TODO Auto Generated method stub
			...
			textInput.textEditorFactory = function():ITextEditor
			{
				...
				editor.textFormat = new TextFormat( "Helvetica", 16, 0xFFFFFF );
		...
		protected function myHeadingText(textInput:TextInput):void
		{
			// TODO Auto Generated method stub
			
			textInput.backgroundSkin = new Image(Texture.fromBitmapData(new BitmapData(1,1,false,0xffffff)));
			trace("got here")
		...
		protected function tipsHeadings(textInput:Label):void
		{
			...
			//textInput. = new Image(Texture.fromBitmapData(new BitmapData(1,1,false,0x000000)));
			trace("got here")
		...
		protected function bitmaptext(textInput:Label):void
		{
			// TODO Auto Generated method stub
			...
			textInput.textRendererFactory = function():ITextRenderer
			{
				var editor:BitmapFontTextRenderer = new BitmapFontTextRenderer();
				editor.wordWrap=true;
				//editor.multiline = true;
				...
				//	editor.textFormat = new BitmapFontTextFormat( "Helvetica", 16, 0xFFFFFF,true,null,null,null,null,TextFormatAlign.CENTER,null,null,null,5 );
				editor.textFormat = new BitmapFontTextFormat(Root.getbitmapfnt(),24);
