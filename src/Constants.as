package
{
    ...
    public class Constants
    {
		...
		public static const TIPS_DETAILS_BODIES_5:Vector.<String> = new <String>["<b>Plan carefully</b><br><br>On the day of your exam make sure that you know when and where the exam is and get" +
			...
			" be a difficult question and the subject that you find more difficult may have a question that you can answer better. Choose the questions that you are able to answer" +
			" most effectively."
			,"<b>Give yourself a clue – Look at the mark scheme</b><br><br>Look at the mark scheme to make sure that you will be answering the question as required. If a question has 3 marks, it is likely to be expecting" +
			" you to point out 3 things, bear this in mind. It will also require less time than a 15 mark answer."
			,"<b>Start with the easiest question</b><br><br>In doing this you will:<br><br>1) Boost your confidence because you will have safely completed a question that you are pleased with<br><br>2) If it is the easiest, " +
			"you should find you spend less time on it. It gives you the opportunity" +
			" to answer it well, but to also give you more time for the question that you think might be harder, without having to start it and then come back to it in fear of running" +
			" out of time."
			,"<b>Answer the question!</b><br><br>It sounds silly, but it is one of the most crucial things to remember. Look for the key words in the question - is it asking you to describe, calculate, analyse, discuss" +
			" the difference between or the benefits of? If you don't answer the question, no matter how good your knowledge is, you won't get the marks."
			,"<b>If you get stuck, move on</b><br><br>On papers with lots of questions, like maths or science, be careful not to wind yourself up on a question that you get stuck on. You don’t have time. Move to the next" +
			...
			,"<b>Keep hydrated and energised</b><br><br>Take some water in with you and sip it slowly (don’t drink too much, you don’t want to be going for a pee). Check this out to see the " +
			...
			,"<b>Show your workings</b><br><br>Keep hydrated and energised</b><br><br>This goes for all exams. Make sure you explain to the examiner what you are doing. For a maths exam, even if you come to the wrong answer, if you can show that you used" +
			...
			,"<b>Running out of time?</b><br><br>Sometimes this happens and if it does you need to know how best to deal with the situation. If you have 2 questions left but you don’t have time to do them both, you" +
		...
		public static const TIPS_DETAILS_BODIES_1:Vector.<String> = new <String>["<b>Getting organised</b><br><br>Stock up on things that you will need so you’re ready to go:<br><br>Highlighters<br>Pens<br>Revision " +
			...
			" covered them."
			,"<b>Creating a planner</b><br><br>This is very much up to you to decide what works for you – we would suggest creating a full version which takes you right up to the exams from the start of when you’re going" +
			...
			,"<b>Mix it up</b><br><br>It’s tempting sometimes to stick to learning the things you like to learn about or find easiest, but as you will have subjects that you might not enjoy so much, it’s good to" +
			...
			,"<b>How long should I revise for at a time?</b><br><br>Using the same principle of breaking your revision down into manageable chunks – you will know how best you work and when your concentration levels might dip – if that’s 45" +
			...
			,"<b>Try to plan to work at times that are best for you</b><br><br>Some people concentrate best in the morning, others better in the afternoon – you need to choose what works for you and plan accordingly. If you lose concentration in the afternoon," +
			" do more in the morning so you have a productive day."
			,"<b>Give yourself a break from time to time – plan in downtime</b><br><br>It’s always good to have some down time and you don’t want to be completely put off by your timetable – it needs to be manageable and workable. You need to give your mind a chance" +
			...
			,"<b>Build in a variation of revision / practice questions / creating essay plans / mindmapping / revise with a friend</b><br><br>Varying your revision techniques can also be a way to make things seem less formulaic and boring.<br><br>There might be days you want to read textbooks and make summary notes, there" +
			...
			" in your mind."
			,"<b>Be flexible</b><br><br>There will be times that you really don’t fancy revising at all. If this is the case, then take the afternoon off and add in the sessions you had planned into another day / put" +
			...
			,"<b>Colour codes</b><br><br>Colour coding is very useful – this is up to you as to what works best but you could do this subject by subject perhaps or by what type of revision technique you’re going to use." +
			...
			,"<b>Getting your exam timetable</b><br><br>Once you have your exam timetable – put it in your planner. This will give you a good idea of how long you have left until your exam dates. It will also help you to know  what you’ll" +
		...
		public static const TIPS_DETAILS_BODIES_4:Vector.<String> = new <String>["<b>Rule number 1</b><br><br>Stock up the short term memory<br><br> It is too late to learn new things, you just want to be consolidating" +
			...
			,"<b>Rule number 3</b><br><br>Eat well!<br><br>You need to feed your brain, give it some protein and steer clear of heavy carbohydrates which can slow you down.  Avoid the false sugar highs from sweets and" +
			" chocolate, have a banana instead. Add some vegetables to the mix to keep you nice and healthy "
			,"<b>Rule number 4</b><br><br>Get a good night’s sleep!<br><br>You don’t want to be tired in the exam otherwise you won’t be able to perform properly. Go to bed at a good time and make sure that your brain" +
		...
		public static const TIPS_DETAILS_BODIES_2:Vector.<String> = new <String>["<b>A balanced diet</b><br><br>Eat lots of vegetables – they will give you lots of minerals and nutrients to keep you going and make you feel better" +
			...
			,"<b>Sleep</b><br><br>Sleep is so important as it gives your body the break it needs. Brain recall becomes stronger after sleep and information becomes easier to access. Make sure you get enough of it –" +
			...
			,"<b>Exercise</b><br><br>Taking exercise is also very important to keep your energy levels up and also get your circulation going. You don’t have to do anything too vigorous, just taking yourself for a walk," +
		...
		public static const TIPS_DETAILS_BODIES_3:Vector.<String> = new <String>["<b>Be organised</b><br><br>Get to the exams on time – know when you exams are being held, where you need to be and how long you should get" +
			...
			,"<b>Try not to panic and remember your brain is a very clever thing</b><br><br>You might feel just before your exams that you can’t remember anything you’ve spent months trying to learn – try and relax and trust your brain – things will come to mind if you" +
			...
			,"<b>Take a deep breath</b><br><br>This doesn’t need to be done in an overt way so people realise you might be panicking, but taking a deep breath when you sit down and open your paper can help just calm your" +
			...
			,"<b>Get some sleep</b><br><br>Sleep helps so much in helping you sort and retain information and also makes you feel much better. Lack of sleep can lead you to becoming worried. If you can’t sleep the" +
			...
			,"<b>Eat well and in a balanced way</b><br><br>Having a good diet will make you feel much more alert, better in yourself and will give you the brain power and energy you need. Lots of carbohydrate at lunch time can" +
			...
			,"<b>Talk to your friends</b><br><br>They might be finding revision and the lead up to exams tricky too and talking to them could be very cathartic. They will understand how you are feeling as they are in the same boat."
			,"<b>Remember - it’s ok!</b><br><br>It’s normal to find exams stressful – not many people think they’re a bundle of fun!<br><br>Everyone in your year group is having to do this as well – you’re not the only one." +
		...
		public static const TIPS_DETAILS_BODIES_0:Vector.<String> = new <String>["<b>Test yourself!</b><br><br>It is all very well reading what you need to know, but you need to make sure that you have learnt it. Some" +
			...
			" question."
			,"<b>Help yourself to remember</b><br><br>Not going in? Our brains tend to remember stuff more easily if we are interested in them, so if a formula, date or name isn’t easy to remember, make it so that it is" +
			...
			,"<b>Understand your brain: focus</b><br><br>Your brain focuses best when there are no distractions: turn off your phone, shut down the internet. This is about you and your exams and nothing else. Your brain is" +
			...
			,"<b>Don’t panic!</b><br><br>Make a revision timetable, and don’t over expect of yourself. Be realistic about what you can cover and when. You don’t want to cram, so start early, testing yourself" +
			...
			,"<b>Stay healthy</b><br><br>Make sure you get good sleep and eat healthily. Drink plenty of water and try not to snack too much. Try to eat fruit and nuts over crisps and chocolate. Get some exercise," +
